...
| Your Backend (i.e. packet is optional but nice to have) | `3` | Request the total available recievers count. Good for analyzing how many active solving instances you can spawn. Structure: <3>. |
